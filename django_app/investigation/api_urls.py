...
from .views import (
    ...
    api_entity_links, api_entity_photo, api_investigation_presence, api_investigation_presence_heartbeat,
...
urlpatterns = [
    ...
    path('investigation/<uuid:investigation_id>/entity/<uuid:entity_id>/photo/', api_entity_photo, name='api_entity_photo'),
