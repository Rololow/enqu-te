...
class Tag(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    investigation = models.ForeignKey(Investigation, on_delete=models.CASCADE, related_name='tags')
...
class Entity(models.Model):
    ...
    photo = models.ImageField(upload_to='entity_photos/', blank=True, null=True)
